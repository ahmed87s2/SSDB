...
namespace SSDB.Shared.Constants.Permission
{
    public static class Permissions
    {
        ...
        {
            public const string View = "Permissions.RegistrationInfo.View";
            public const string Export = "Permissions.RegistrationInfo.Export";
            public const string Search = "Permissions.RegistrationInfo.Search";
            public const string UpdateInfo = "Permissions.RegistrationInfo.UpdateInfo";
        }
        ...
        public static class Universities
        {
            ...
            public const string Create = "Permissions.Universities.Create";
            public const string Edit = "Permissions.Universities.Edit";
            public const string Delete = "Permissions.Universities.Delete";
            public const string Export = "Permissions.Universities.Export";
            public const string Search = "Permissions.Universities.Search";
        }
