...
{
    public partial class AddEditUniversityModal
    {
        [Inject] private IUniversityManager UniversityManager { get; set; }

        [Parameter] public AddEditUniversityCommand AddEditUniversityModel { get; set; } = new();
        ...
        {
            var response = await UniversityManager.SaveAsync(AddEditUniversityModel);
