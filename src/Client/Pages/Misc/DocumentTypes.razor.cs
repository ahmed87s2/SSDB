...
namespace SSDB.Client.Pages.Misc
{
    public partial class DocumentTypes
    {
        ...
        private bool Search(GetAllDocumentTypesResponse University)
        {
            ...
            if (University.Description?.Contains(_searchString, StringComparison.OrdinalIgnoreCase) == true)
            {
                return true;
            }
            return false;
